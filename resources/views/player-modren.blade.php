...
<head>
    ...
    <title>SportsMagazine Player Modren</title>
                            ...
                            <div class="sportsmagazine-player sportsmagazine-classic-player">
                                <ul class="row">
                                    @foreach ($players as $player)
                                        <li class="col-md-4">
                                            <figure>
                                                <a href="player-detail.html"><img src="{{ asset($player->image) }}" alt=""></a>
                                                <figcaption>
                                                    <div class="sportsmagazine-classic-player-info">
                                                        <h4><a href="player-detail.html">{{ $player->fullname }}</a></h4>
                                                        <span>{{ $player->position }}</span>
                                                        <ul class="classic-player-option">
                                                            <li><i class="fa fa-calendar-o"></i> <time datetime="{{ $player->dateofbirth }}">{{ $player->dateofbirth }}</time></li>
                                                            <li><i class="fa fa-futbol-o"></i> <span>{{ $player->goalsnumber }} Goals</span></li>
                                                        </ul>
                                                        <p>{{ $player->content }}</p>
                                                        <a href="player-detail.html" class="classic-redmore-btn">READ MORE</a>
                                                    </div>
